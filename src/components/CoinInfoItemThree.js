...
const CoinInfoItemThree = () => {
    const [val, setVal] = useState('Tabs 3')
        ...
        <div className={s.coinInfoItem}>
            ...
            <div className={s.footer}>
                ...
                <div className={s.rowItem}>
                    ...
                    <div className={s.content}>
                        <a href="https://bscscan.com/token/0x320d31183100280CcdF69366CD56180Ea442A3E8" target="_blank" className="navLinkBlue me-4">BSC Explorer</a>
                        <a href="https://www.youtube.com/watch?v=esLo5fQQLCo&t" target="_blank" className="navLinkBlue me-4">LHC Staking Tutorial</a>
...
export default CoinInfoItemThree;